...
const translations = {
  ...
  es: {
    ...
    freeChannelInvite: '🎁 *¡Regalo de Bienvenida!*\n\nAquí está tu invitación exclusiva a nuestro canal GRATIS:\n\n{inviteLink}\n\n¡Únete ahora para acceder a contenido premium!',
    freeChannelInviteError: '⚠️ No se pudo generar el enlace de invitación al canal.\n\n¡No te preocupes, puedes unirte después desde el menú!',
    profileCreated: '🎉 *¡Bienvenido al Culto!*\n\n¡Tu perfil ha sido creado exitosamente!\n\nAhora tienes acceso a todas las funciones.',
